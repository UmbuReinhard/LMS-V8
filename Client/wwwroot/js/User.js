...
function liveSearch() {
    ...
    let cards = document.querySelectorAll('#card23')
...
$.ajax({
    ...
    console.log(result);
    let itemUser = result.filter(ef => ef.userId == parseInt(document.getElementById("UserIdNihh").value) && ef.status == "Accept");
    ...
    if (itemUser != null) {
        ...
        text +=
            ...
            `<div class="card">
                ...
                <!-- Card body -->
                <div class="card-body">
                    <p class="card-text mb-4 text-justify">You Have 0 Course </p>
                </div>
            </div>`;
      }
